...
const Listado = () => {
    ...
    //API:
    const API = 'https://api.themoviedb.org/3/discover/movie?api_key=6059216fb415c21feabd30ee81b69d48&language=en-US&sort_by=popularity.desc&include_adult=false&include_video=false&page=1&with_watch_monetization_types=flatrate'
